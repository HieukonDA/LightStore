...
public class Strings
{
    ...
    public struct StaticRoles
        ...
        {
            // Success Messages
            public const string LoginSuccessful = "Success: Login successful!";
            ...
            public const string ResendOTPSuccessfully = "Success: Resend OTP successfully, please check your email.";
            ...
            public const string OauthLoginFail = "Error: Failed to login with provider.";
            public const string OauthUnsupportedProvider = "Error: Unsupported provider.";
            public const string OauthUnvalidPlatform = "Error: Unvalid platform.";
            public const string OauthRequire = "Error: Code, provider and platform is require.";
            public const string DuplicateLanguageCode = "Error: Duplicate language code.";
            public const string DuplicateLanguageName = "Error: Duplicate language name. ";
            public const string OnlyOneDefaultLanguage = "Error: Only one default language. ";
            public const string IsSelected = "Error: Language is selected";
