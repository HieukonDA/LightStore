...
public partial class DBContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            entity.Property(e => e.GHNSortCode).HasMaxLength(50);
            entity.Property(e => e.GHNTransType).HasMaxLength(50);
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ProductVA__3214EC0799B3AB16");

            entity.HasIndex(e => e.VariantId, "IX_ProductVariantAttributes_VariantId");

            entity.HasIndex(e => e.AttributeId, "IX_ProductVariantAttributes_AttributeId");

            entity.HasIndex(e => new { e.VariantId, e.AttributeId }, "UQ_ProductVariantAttribute").IsUnique();
            ...
            entity.HasOne(d => d.Variant).WithMany(p => p.ProductVariantAttributes)
                .HasForeignKey(d => d.VariantId)
                .HasConstraintName("FK__ProductVA__Varia__1CBC4617");

            entity.HasOne(d => d.Attribute).WithMany()
                .HasForeignKey(d => d.AttributeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ProductVA__Attri__1CBC4618");

            entity.HasOne(d => d.Value).WithMany()
                .HasForeignKey(d => d.ValueId)
                .HasConstraintName("FK__ProductVA__Value__1CBC4619");
        });
